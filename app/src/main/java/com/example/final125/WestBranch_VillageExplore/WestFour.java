...
public class WestFour extends AppCompatActivity {
    private Button home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_west_four);
        hideSystemUI();
    ...
    public void advanceSuccess() {
        Intent intent = new Intent(this, WestFiveSucceed.class);
        startActivity(intent);
    }
    public void advanceFail() {
        Intent intent = new Intent(this, WestFiveFail.class);
        startActivity(intent);
    }
